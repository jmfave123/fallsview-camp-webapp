...
export const Route = createFileRoute("/explore")({
  head: () => ({
    meta: [
      { title: "Waterfall Trekking & Activities — Falls View Camp Sergio Osmeña" },
      {
        name: "description",
        content:
          "Experience guided waterfall trekking, organic farm tours, rock-pool swims, sunset bonfires, and sunrise ridge walks at Falls View Camp in Sergio Osmeña.",
      },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Explore Activities & Waterfall Treks — Falls View Camp" },
      {
        property: "og:description",
        content: "Guided waterfall treks, organic farm tours, and sunrise ridge walks in Sergio Osmeña, Zamboanga del Norte.",
      },
    ],
    links: [
      { rel: "canonical", href: "https://fallsview-camp-webapp.lovable.app/explore" },
    ],
  }),
  component: Explore,
});
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-14">
      ...
      <div className="card-camp card-interactive rise-in delay-4 mt-12 flex flex-col gap-4 p-8 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link to="/" hash="book" className="btn-base btn-water shrink-0 transition-transform hover:-translate-y-0.5">
          Book a Stay
        </Link>
      </div>
    </div>
