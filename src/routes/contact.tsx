...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Location, Contact & Directions — Falls View Camp Sergio Osmeña" },
      {
        name: "description",
        content:
          "Find Falls View Camp in Sergio Osmeña, Zamboanga del Norte. View location maps, contact details, phone, email, and send booking inquiries.",
      },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Contact & Directions — Falls View Camp" },
      {
        property: "og:description",
        content: "Location map, contact details, and booking inquiry form for Falls View Camp in Sergio Osmeña.",
      },
    ],
    links: [
      { rel: "canonical", href: "https://fallsview-camp-webapp.lovable.app/contact" },
    ],
  }),
  component: Contact,
});
...
const details = [
  {
    icon: MapPin,
    label: "Location",
    value: " Brgy. Tinindugan Sergio Osmena,Zamboanga Del Norte.",
  },
  { icon: Phone, label: "Mobile Number", value: "0995-514-9190" },
...
export function Contact() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-14">
      ...
      <h1 className="mt-3 text-4xl rise-in delay-1 sm:text-5xl">Contact Falls View Camp</h1>
      <p className="mt-4 max-w-2xl text-muted-foreground rise-in delay-2">
        Use the map, phone number, or email below for directions, availability, and other questions.
      </p>
